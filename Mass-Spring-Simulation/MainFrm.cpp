...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND(ID_INTRK5, OnIntrk5)
	ON_UPDATE_COMMAND_UI(ID_INTRK5, OnUpdateIntrk5)
	...
	//}}AFX_MSG_MAP
	ON_COMMAND(ID_INTEGRATOR_HEUN, &CMainFrame::OnIntegratorHeun)
...
void CMainFrame::OnIntrk5()
{
	m_OGLView.m_PhysEnv.m_IntegratorType = RK5_INTEGRATOR;
	m_OGLView.Invalidate(TRUE);
}

void CMainFrame::OnUpdateIntrk5(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(m_OGLView.m_PhysEnv.m_IntegratorType == RK5_INTEGRATOR);
}
...
void CMainFrame::OnIntegratorHeun()
{
	m_OGLView.m_PhysEnv.m_IntegratorType = HEUN_INTEGRATOR;
	m_OGLView.Invalidate(TRUE);
}

void CMainFrame::OnUpdateIntegratorHeun(CCmdUI *pCmdUI)
{	
	pCmdUI->SetCheck( m_OGLView.m_PhysEnv.m_IntegratorType == HEUN_INTEGRATOR );
}

void CMainFrame::OnIntegratorAdaptiverk4()
{
...
{
	pCmdUI->SetCheck( m_OGLView.m_PhysEnv.m_IntegratorType == RK4_ADAPTIVE_INTEGRATOR );
}
